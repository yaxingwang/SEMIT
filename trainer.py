...
class Trainer(nn.Module):
    ...
    def gen_update(self, co_data, cl_data, octave_alpha, hp, multigpus):
        
        self.gen_opt.zero_grad()
        al, ad, xr, cr, sr, ac = self.model(co_data, cl_data, octave_alpha, hp, 'gen_update')
    ...
    def dis_update(self, co_data, cl_data, octave_alpha, hp):
        self.dis_opt.zero_grad()
        al, lfa, lre, reg, acc = self.model(co_data, cl_data, octave_alpha, hp, 'dis_update')
